...
<div>
	第${page.pageNum}页/共${page.totalPageSize}页&nbsp;&nbsp; <a
		href="${pageContext.request.contextPath}${page.url}&num=1">首页</a>&nbsp;&nbsp;
	<a
	...
	<a
		href="${pageContext.request.contextPath}${page.url}&num=${page.totalPageSize}">尾页</a>&nbsp;&nbsp;
	<select id="jump" onchange="jump(this)">
		...
		type="button" value="跳转" onclick="jump1()" />
