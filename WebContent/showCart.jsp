	...
	<table border="1" width=800">
		...
		<c:forEach items="${sessionScope.cart.items}" var="me" varStatus="vs">
			<tr class="${vs.index%2==0?'even':'odd'}">
				...
				<td><input type="text" size="3" id="number" name="number"
					value="${me.value.number}"
					onchange="changeNumber(this,'${me.value.number}','${me.key}')" /></td>
		...
		<tr>
			<td align="right" colspan="6">
				...
				总金额：${sessionScope.cart.price}&nbsp;&nbsp; <a
				href="${pageContext.request.contextPath}/servlet/ClientServlet?op=genOrder">去结算</a>
			</td>
		</tr>
	</table>
</c:if>
