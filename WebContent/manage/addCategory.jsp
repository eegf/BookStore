...
<h3>当前位置：添加新分类</h3>
<form
	action="${pageContext.request.contextPath}/servlet/ManageServlet?op=addCategory"
	method="post">
	<table border="1" width="438">
		<tr>
			<td>分类名称：</td>
			<td><input name="name" id="name" /><span id="sname"></span></td>
		</tr>
		<tr>
			<td>描述：</td>
			<td><textarea rows="3" cols="38" name="des"></textarea></td>
		</tr>
	</table>
